...
export class Words {
  ...
  readonly historicalStats =
    signal<Record<string, WordStats>>({});
  ...
  readonly unlockedDifficulty =
    computed<WordDifficulty>(() => {
  ...
  toggleHelp(): void {
    ...
    this.registerSessionHelp(
      word
    );


    this.registerHistoricalHelp(
      word
    );
  ...
  private createSession(): void {
    ...
    session =
      this.avoidConsecutiveDuplicates(
        session
      );
  ...
  private avoidConsecutiveDuplicates(
    words: ReadingWord[]
  ): ReadingWord[] {
  ...
  private registerHistoricalHelp(
    word: string
  ): void {
  ...
  private registerSessionHelp(
    word: string
  ): void {

    this.sessionHelp.update(
      help => ({
